...
# Inherit some common Bee stuff.
$(call inherit-product, vendor/bee/config/common_full_phone.mk)

# Enhanced NFC
$(call inherit-product, vendor/bee/config/nfc_enhanced.mk)

PRODUCT_NAME := bee_d855
